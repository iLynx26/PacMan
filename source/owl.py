...
class Owl:
    def __init__(self, x, y, min_speed, max_speed):
        image = pygame.image.load('images/paintdotnetowl.png')
        ...
        for direction in ["down", "left", "right", "up"]:
            ...
            for number in range(6, 9):
                frame = image.subsurface((number * 77, y * 48, 77, 48))
    ...
    def set_direction(self, map):
        ...
        # 1 in dist chance that the owl doesn't follow the pacman.
        # If the pacman is below, up is removed, above the owl - down is removed, etc.
